...
def publisher_list(request):
    ...
    return render(request, 'app01/publisher_list.html', {'publisher_list': publisher})
...
def add_publisher(request):
    ...
    return render(request, 'app01/add_publisher.html')
...
def edit_publisher(request):
    ...
    edit_id = request.GET.get('id')
    edit_obj = models.Publisher.objects.get(id=edit_id)
    return render(request, 'app01/edit_publisher.html', {'publisher': edit_obj})


# 书籍的列表
def book_list(request):
    book = models.Book.objects.all()
    return render(request, 'app01/book_list.html', {'book_list': book})
...
def add_book(request):
    ...
    return render(request, 'app01/add_book.html', {'publisher_list': res})
...
def edit_book(request):
    ...
    return render(request, 'app01/edit_book.html', {'book': edit_obj, 'publisher_list': all_publisher})


# 作者的列表
def author_list(request):
    author = models.Author.objects.all()
    return render(request, 'app01/author_list.html', {'author_list': author})
...
def add_author(request):
    ...
    return render(request, 'app01/add_author.html')
...
def edit_author(request):
    ...
    return render(request, 'app01/edit_author.html', {
        'author': edit_obj,
        'book_list': all_book
    })
